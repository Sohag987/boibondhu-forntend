        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="flex flex-col gap-3 border-t border-[#C8B9A8] pt-4">
            <div className="flex flex-col gap-1">
              <p className="text-[#8C7B6E] text-xs">Lending duration</p>
              <p className="text-[#2C2416] text-lg font-semibold">{book.duration} days</p>
              <p className="text-[#8C7B6E] text-xs leading-relaxed">
                This book is available to borrow for {book.duration} days. Contact the lender to arrange handover and return date.
              </p>
            </div>

            <div className="flex flex-col gap-1 bg-[#EDE4D8] border border-[#C8B9A8] rounded-xl px-4 py-3">
              <p className="text-[#8C7B6E] text-xs">Borrowing is</p>
              <p className="text-[#298b8c] text-sm font-semibold">Completely free</p>
            </div>
          </div>
        </div>

        {/* Right — lender contact */}
        {book.lender && (
          <div className="sm:w-52 shrink-0">
            <div className="bg-[#EDE4D8] border border-[#C8B9A8] rounded-xl p-5 flex flex-col gap-4 sticky top-24">
              ...
              <div className="flex items-center gap-3">
                {book.lender.picture ? (
                  <img
                    src={book.lender.picture}
                    alt={book.lender.first_name}
                ...
                <div>
                  <p className="text-[#2C2416] text-sm font-semibold">
                    {book.lender.first_name} {book.lender.last_name}
                  </p>
                  <p className="text-[#8C7B6E] text-xs">Lender</p>
                </div>
              </div>
              ...
              {book.lender.phone && (
                <div className="flex flex-col gap-1 border-t border-[#C8B9A8] pt-3">
                  ...
                  <p className="text-[#2C2416] text-xs font-medium">{book.lender.phone}</p>
                </div>
              )}
              ...
              {book.lender.email && (
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[#2C2416] text-xs font-medium break-all">{book.lender.email}</p>
                </div>
              )}
              ...
              <div className="flex flex-col gap-2 border-t border-[#C8B9A8] pt-3">
                {book.lender.phone && (
                  ...
                  <a  href={`https://wa.me/88${book.lender.phone}`}
                    target="_blank"
                    rel="noreferrer"
                ...
                {book.lender.email && (
                 ...
                 <a   href={`mailto:${book.lender.email}`}
                ...
                {!book.lender.phone && !book.lender.email && (
